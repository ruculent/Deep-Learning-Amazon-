...
class DirectoryIterator(Iterator):
    ...
    def __init__(self, directory, image_data_generator,
        ...
        col_0 = self.df.columns[0]
        col_1 = self.df.columns[1]

        for i in self.df[col_1]:
            self.classes_list.extend(i)
        self.classes_list = sorted(list(set(self.classes_list)))

        self.num_classes = len(self.classes_list)
        self.class_indices = dict(zip(self.classes_list, range(len(self.classes_list))))
        # self.samples = len(os.listdir(directory))
        ...
        self.filenames = [i for i in self.df[col_0]]
        self.classes = [i for i in self.df[col_1]]
    ...
    def _get_batches_of_transformed_samples(self, index_array):
        ...
        batch_y = MultiLabelBinarizer().fit_transform(self.classes)[index_array]
